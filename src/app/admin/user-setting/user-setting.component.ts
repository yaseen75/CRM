    ...
    sidebar-gradient-color7  sidebar-solid-black`;
      ...
      $('#theme-change2 span').on('click', function () {
        ...
        if ($(this).hasClass('sidebar-solid-orange')) {
          $('body')
            .removeClass(sidebarColors2)
            .addClass('sidebar-solid-orange');
